...
class Lead
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=LeadStatus::class, inversedBy="leads")
     * @ORM\JoinColumn(nullable=false)
     */
    private $status;

    /**
     * @ORM\OneToMany(targetEntity=Opportunity::class, mappedBy="lead", orphanRemoval=true)
     */
